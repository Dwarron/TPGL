...
public class Orange {
    ...
    public static void main (String[] args){
        ...
        Orange ConstructeurDefaut = new Orange();
        Orange ConstructeurParam1 = new Orange(15, "Bretagne");
        Orange ConstructeurParam2 = new Orange(10, "");
        Orange ConstructeurParam3 = new Orange(-4, "Hongrie");
